package cn.maplerabbit.rlg.mybatis;
        ...
        implements Interceptor
{
    ...
    public String appendModifiedTimeField(String sqlStatement, LocalDateTime dateTime)
    {
        ...
        {
            log.debug("原SQL语句中已经包含modified_time，将不补充添加时间字段");
            return null;
        }
        ...
        if (whereClauseMatcher.find())
        {
            ...
            String newSetClause = new StringBuilder(", ")
                            .append(FIELD_MODIFIED)
                            .append("='")
                            .append(dateTime)
                            .append("'")
                            .toString();
    ...
    public String appendCreateTimeField(String sqlStatement, LocalDateTime dateTime)
    {
        ...
        if (gmtPattern.matcher(sqlStatement).find())
        {
            log.debug("已经包含 create_time 不再添加 时间字段");
            return null;
        }
